...
export default function Categories() {
 ...
 return (
  <>
 {categories == undefined? <div className='loading-screen'>
...
<i className="fa-solid fa-diamond fa-2x me-4 fa-bounce"></i>
   ...
   <div className="container py-5">
    ...
    <link rel="icon" href="./img/logo.png" />
                <title>category : {path}</title>
            </Helmet>

     {categories.slice(0,all).map( (elem , index) =>   <div key={index} className="col-lg-3 col-md-6  elemnt-facous">
